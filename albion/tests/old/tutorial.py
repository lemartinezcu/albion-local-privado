...
if __name__ == "__main__":
    ...
    zip_ref = zipfile.ZipFile(
        os.path.join(os.path.dirname(__file__), "..", "data", "nt.zip"), "r"
    )
    ...
    with project.connect() as con:
        ...
        dataSource = driver.Open(
            os.path.join(os.path.dirname(__file__), "tutorial_named_section.gpkg"), 0
        )
        data = [
            (feature.GetField("section"), feature.GetGeometryRef().ExportToWkb().hex())
